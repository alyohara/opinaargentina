    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48" style="margin-right:10 px;">
                    <x-slot name="trigger">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link href="{{ route('telefonos.index') }}" :active="request()->routeIs('telefonos.index')">
                            {{ __('Administrar Teléfonos') }}
                        </x-dropdown-link>
                        <x-dropdown-link href="{{ route('exports.index') }}" :active="request()->routeIs('exports.index')">
                            {{ __('Exported Files') }}
                        </x-dropdown-link>
                    </x-slot>
                </x-dropdown>
